...
if __name__ == '__main__':
    ...
    (then all of the same args for 2ndary associations)
    '''
    # 
    ...
    testSentence(predicate, 8, 'boundedAdd', 0.04, 0.0, 0.3, 
                0.0, 0.7, 5.0, 
                0.0, 0.0,
                'boundedAdd', 0.04, 0.0, 0.3, 
                0.0, 0.7, 5.0, 
                0.0, 0.0)     
    print '\n***identical params for secondary, but not necessarily identical result'
    testSentence(predicate, 8, 'boundedAdd', 0.04, 0.0, 0.1, 
                0.0, 0.7, 5.0, 
                0.3, 0.3,
                'boundedAdd', 0.04, 0.0, 0.1, 
                0.0, 0.7, 5.0, 
                0.3, 0.3)     
    print '\n*** backwards memory'
