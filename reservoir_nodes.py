...
# Axel: somehow Oger causes severe problems when used with the
# multiprocessing module. I tried removing dependency on parallel
# subpackage, to no avail. Dirty solution: copy the source code here,
# and include the get_spectral_radius method. Maybe if we used OpenMP
# instead, this problem would not appear. But multiprocessing is more
# pythonic, in my opinion (and probably a bit easier).
